...
from examples.arabic.bl_arabert_v2_tokenized.arabic_bl_arabert_v2_t_config import TEMP_DIRECTORY, config, MODEL_TYPE, MODEL_NAME, SEED
...
print("preprocess tokenization done!")
