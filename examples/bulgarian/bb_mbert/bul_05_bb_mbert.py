...
# Class count
count_class_no, count_class_yes = full.q5_label.value_counts().sort_index(ascending=False)

# Divide by class
df_class_no = full[full['q5_label'] == "no"]
df_class_yes = full[full['q5_label'] == "yes"]

size_counter = sample_size_counter(df_class_no['q5_label'].count(), df_class_yes['q5_label'].count())
...
full['labels'] = encode(full["q5_label"])
