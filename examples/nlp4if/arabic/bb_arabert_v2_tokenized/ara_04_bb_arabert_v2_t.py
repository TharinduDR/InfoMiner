...
train.dropna(subset=["q4_label"], inplace=True)

# Class count
count_class_no, count_class_yes = train.q4_label.value_counts().sort_index(ascending=True)
...
train['labels'] = encode(train["q4_label"])
