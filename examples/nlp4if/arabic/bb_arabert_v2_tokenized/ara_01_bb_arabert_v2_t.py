...
train.dropna(subset=["q1_label"], inplace=True)

# Class count
count_class_no, count_class_yes = train.q1_label.value_counts().sort_index(ascending=True)

# Divide by class
df_class_no = train[train['q1_label'] == "no"]
df_class_yes = train[train['q1_label'] == "yes"]
...
dev.dropna(subset=["q1_label"], inplace=True)
